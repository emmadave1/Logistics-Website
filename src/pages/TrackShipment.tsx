...
export default function TrackShipment() {
  ...
  const [notifications, setNotifications] = useState<
    {
      id: string;
      type: "eta" | "delivered" | "status" | "location";
      title: string;
      description: string;
      at: string;
    }[]
 ...
 const check = async () => {
  try {
    const latestResponse = await trackShipment(currentId);
    ...
    if (latest.estimatedDelivery !== prev.eta) {
      news.push({
        ...
        description: `New estimated delivery: ${formatDateTime(
    ...
    const latestLocation =
      `${latest.currentLocation.city}, ${latest.currentLocation.country}`;
        ...
        latest.status === 'delivered'
          ? {
              ...
              description: `${latest.trackingId} was marked as delivered${
                latest.deliveredAt
                  ? ` on ${formatDateTime(latest.deliveredAt)}`
                  : ''
              }.`,
              at: new Date().toISOString(),
            }
          ...
          >
                ...
                {notifications.map((n) => (
                  ...
                  >
                    ...
                    <button
                      ...
                      onClick={() =>
                        setNotifications((c) => c.filter((x) => x.id !== n.id))
                      }
                ...
                <div className="grid md:grid-cols-3 gap-4">
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      ...
                      <p className="font-medium">
                        {formatWeight(shipment.packageWeight)}
                      </p>
                    </div>
                  </div>
                </div>
              ...
              <CardContent>
                <div className="relative">
                  {shipment.timeline.map((item, index) => {
                    const StatusIcon =
                      statusConfig[item.status]?.icon || Package;
                    return (
                      <div
                        key={item.status}
            ...
            <Card>
              <CardHeader>
                ...
                <p className="text-sm text-muted-foreground">
                  Every delivery date, time and status change made by our
                  operations team.
                </p>
              </CardHeader>
              <CardContent>
                {events.length === 0 ? (
                  <p className="text-sm text-muted-foreground py-4 text-center">
                    No updates yet. You will see every change here as soon as it
                    happens.
                  </p>
                ) : (
            ...
            <div className="grid md:grid-cols-2 gap-6">
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {shipment.pickupLocation}, {shipment.pickupCity},{" "}
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className="text-sm text-muted-foreground mt-1">
                    {shipment.deliveryLocation}, {shipment.deliveryCity},{" "}
